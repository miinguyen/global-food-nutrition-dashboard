...
\begin{frame}{What does the world eat?}
    \begin{center}
        \includegraphics[width=\textwidth,height=0.75\textheight,keepaspectratio]{sceen1.png}
    \end{center}
\end{frame}

\begin{frame}{How healthy is it?}
    \begin{center}
        \includegraphics[width=\textwidth,height=0.75\textheight,keepaspectratio]{sceen2.png}
    \end{center}
\end{frame}

\begin{frame}{What's in our food?}
    \begin{center}
        \includegraphics[width=\textwidth,height=0.75\textheight,keepaspectratio]{sceen3.png}
    \end{center}
\end{frame}

\begin{frame}{My Diet Simulator}
    \begin{center}
        \includegraphics[width=\textwidth,height=0.75\textheight,keepaspectratio]{sceen4.png}
    \end{center}
\end{frame}
